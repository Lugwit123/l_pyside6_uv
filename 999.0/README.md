...
| 依赖 | `python-3.9+`<br>`pyside6`<br>`qtpy` |
| 提供 | PYTHONPATH {root}/src<br>env PYSIDE6_UV_ROOT<br>PYTHONIOENCODING=utf-8 |
| 入口 | `l_pyside6_uv` |
| 用法 | `wuwo l_pyside6_uv` 进入该包环境<br>`wuwor l_pyside6_uv -- l_pyside6_uv` 直接调用别名 |
